import ChatBot from "@/app/(workspace)/space/workspace/robot-chat/bot-group/app/chatbot";
import BotGroup, {defaultApp} from "@/app/(workspace)/space/workspace/robot-chat/bot-group";
import styles from "./index.module.scss";
import Conversation from "@/app/(workspace)/space/workspace/robot-chat/conversation";
