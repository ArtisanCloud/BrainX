...
import {
  ...
  ActionRunMultiple30SecondsTasks,
  ResponseQueryTasksStatus,
} from "@/app/api/task";
      ...
      if (res) {
        ...
        Object.keys(res).forEach((taskId, index) => {
          ...
          if (taskStatus.state == "SUCCESS") {
            ...
            newProgressStatus[index] =
              (taskStatus.current! / taskStatus.total!) * 100; // 获取当前进度，默认值为 0
          } else {
        ...
        const allCompleted = newProgressStatus.every(
          (status) => status === 100
        );
