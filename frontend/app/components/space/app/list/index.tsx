...
import {
  FetchAppListContext,
  FetchAppListContextType
} from "@/app/components/space/app/provider/fetch-app-list-provider";
...
const AppList = () => {
  ...
  }, [pagination?.page, pagination?.per_page, fetchAppList, setAppList, setPagination]); // 添加缺失的依赖项
