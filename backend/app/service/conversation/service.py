...
class ConversationService:
    ...
    async def create_conversation(self, conversation: Conversation) -> Tuple[Conversation | None, Exception | None]:
        try:
            created_conversation, exception = await self.conversation_dao.create(conversation)
            return created_conversation, exception
