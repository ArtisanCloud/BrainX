...
from app.service.media_resource.service import (
    MediaResourceService,
    transform_media_resource_to_reply,
)
...
async def create_media_resource_by_file(
   async_db: AsyncSession,
    ...
    media_resource, exception = await service_media_resource.create_media_resource(
        media_resource
    )
    if exception:
