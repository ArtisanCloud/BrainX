...
from app.dao.media_resource.media_resource import (
    MediaResourceDAO,
    FindManyMediaResourcesOption,
    get_media_type,
)
...
class MediaResourceService:
    ...
    async def make_oss_resource_by_base64_string(
        ...
        try:
            ...
            return await self.make_oss_resource_by_base64_data(
                user, bucket, data, content_type, media_name, sort_index
            )
    ...
    async def make_oss_resource_by_base64_data(
        ...
        try:
            ...
            info = self.oss_client.save(
                bucket, object_name, data, len(data), content_type=content_type
            )
