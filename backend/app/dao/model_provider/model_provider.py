...
class ModelProviderDAO(BaseDAO[ModelProvider]):
    ...
    #     ModelProvider | None, SQLAlchemyError | None]:
    #     try:
    ...
    #         return None, e
    #
    # async def get_model_provider_by_uuid(self, provider_uuid: str) -> Tuple[ModelProvider | None, SQLAlchemyError | None]:
    #     try:
    ...
    #         -> Tuple[ModelProvider | None, SQLAlchemyError | None]:
    #     try:
    ...
    #         return None, e
    #
    # async def delete_model_provider(self, provider_uuid: str) -> Tuple[bool, SQLAlchemyError | None]:
    #     try:
    #         model_provider = await self.get_model_provider_by_uuid(provider_uuid)
    #         if not model_provider:
