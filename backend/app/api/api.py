...
from app.api.question_answer import (
    query_controller,
    visual_search_controller,
    visual_query_controller,
)
...
# media resource
api_router.include_router(
    media_resource_controller.router,
    prefix="/media/resource",
    dependencies=[Depends(auth_user_token)],
...
# conversation
api_router.include_router(
    conversation_controller.router,
    prefix="/chat-bot/conversation",
    dependencies=[Depends(auth_user_token)],
    tags=["chatbot"],
)
api_router.include_router(
    message_controller.router,
    prefix="/chat-bot/conversation/message",
    dependencies=[Depends(auth_user_token)],
    tags=["chatbot"],
)
...
api_router.include_router(
    visual_query_controller.router,
    prefix="/question-answer",
    dependencies=[Depends(auth_user_token)],
    tags=["visual_query"],
)
api_router.include_router(
    visual_search_controller.router,
    prefix="/question-answer",
    dependencies=[Depends(auth_user_token)],
    tags=["visual_search"],
)
...
api_router.include_router(
    ...
    prefix="/rag/dataset/document",
    dependencies=[Depends(auth_user_token)],
    tags=["rag", "document"],
)
api_router.include_router(
    document_segment_controller.router,
    prefix="/rag/dataset/document/segment",
    dependencies=[Depends(auth_user_token)],
