...
from app.models.base import table_name_provider_model, time_now
...
def downgrade() -> None:
    op.drop_table(table_name_provider_model, schema=settings.database.db_schema, if_exists=True)
