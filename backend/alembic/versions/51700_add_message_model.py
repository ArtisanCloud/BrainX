...
from app.models.base import table_name_message, table_name_conversation, time_now
...
def downgrade() -> None:
    op.drop_table(table_name_message, schema=settings.database.db_schema, if_exists=True)
