...
task-run:
	...
	./dist/task/task -A app.service.task.celery_worker -n brainx@worker_task --loglevel=info -P gevent

task-rag-run:
	echo "Running celery rag task in production mode."
	./dist/task/task -A app.service.task.celery_worker -Q rag_queue -n brainx@worker_rag --loglevel=info -P gevent
